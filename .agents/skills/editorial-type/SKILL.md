...
- Resend code editorial: `#000000/#292d30/#f0f0f0/#ffffff`, blue `#3b9eff`, statuses `#3ad389/#ff9592/#ffca16/#70b8ff/#baa7ff`, violet gradient for rare emphasis; Inter, Domaine, ABCFavorit, CommitMono; 1200px max, tags 10px, cards 16/24px, buttons/badges 6px. Code/editor blocks can stream text, but title columns stay static.
- ElevenLabs type restraint: `#fdfcfc/#f5f3f1/#e5e5e5/#777169/#000000`, dots `#0447ff/#ff4704`; Waldenburg 300 at 32/36/48px with 1.08-1.17 leading and `-0.02em` tracking; Inter metadata 10-20px; 80-120px sections, 16-24px cards, 9999px pills, 4px inputs. Use black CTA punctuation only once per viewport.
- Slite warm editorial workspace: `#f9efe4/#fdfdfd/#3f434a/#2d2f34/#2e77e5`, muted badge fills `#fbf4d8/#fae9f4`; Garnett 500/700 24-64px, UniversalSans body 12-16px; nav 72px, 3-column cards with 24px gutters, cards 12px, buttons 42-50px, tooltip 8px.
- State transfer: Resend maps success/error/warning/info to `#3ad389/#ff9592/#ffca16/#70b8ff`; ElevenLabs hover row `#f5f3f1`; Slite focus links use `#2e77e5` while active dark CTA remains `#2d2f34`.
...
Refero ready-to-use deltas from Resend/ElevenLabs/Slite:
- Token roles: Resend dark editorial `#000000/#292d30/#f0f0f0/#ffffff` with action `#3b9eff` and statuses `#3ad389/#ff9592/#ffca16/#70b8ff/#baa7ff`; ElevenLabs `#fdfcfc/#f5f3f1/#e5e5e5/#777169/#000000`; Slite `#f9efe4/#fdfdfd/#3f434a/#2d2f34/#2e77e5`.
- Type roles: Domaine/ABCFavorit/CommitMono for code editorial; Waldenburg 32/36/48px for restrained display; Garnett 24-64px for warm workspace headings.
...
- Resend: Domaine 77/96px display, ABCFavorit 56px at `-0.05em`, Inter UI 12-24px, CommitMono 12-16px.
- ElevenLabs: Waldenburg 300 at 32/36/48px, 1.08-1.17 leading.
- Slite: Garnett 500/700 24-64px, body UniversalSans 12-16px.
...
- Resend: 1200px max, 80-120px sections, 32px cards, 6/10/16/24px radius code frames.
- ElevenLabs: 80-120px sections, 16-24px cards, 9999px pills, 4px inputs.
- Slite: 72px nav, 24px gutters, 12px cards, 42-50px buttons.
...
- Resend: dark code panels, 1px `#292d30` borders, 6px buttons/badges, 10px tags, status chips.
- ElevenLabs: black CTA punctuation, pill tags, voice/demo panels.
- Slite: dark CTA, blue text link, warm badge fills `#fbf4d8/#fae9f4`.
...
Refero state deltas:
- Resend success/error/warning/info: `#3ad389/#ff9592/#ffca16/#70b8ff`.
- ElevenLabs hover row `#f5f3f1`; Slite focus links `#2e77e5`, active dark CTA `#2d2f34`.
...
Refero motion delta:
- Resend code/editor blocks may stream/fade while title columns stay static; ElevenLabs/Slite use existing editorial timing only. Do not animate text width or column layout.
...
- Refero anti-dilution: do not mix Resend dark code statuses with Slite parchment badges unless the page has a clear code-editor/workspace split.
- Do not use decorative color in headlines; source accents must map to CTA, link, status, or selected row.
