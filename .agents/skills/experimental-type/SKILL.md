...
Refero ready-to-use deltas from FORA/Datalands/Discord:
- Token roles: FORA `#ffffff/#000000/#a9553c/#a04d35/#ddbdea/#ffffff59`; Datalands `#000000/#ffffff/#111212/#f3f3ef/#fc74dd/#122d8b/#94bcee/#ff4c33`; Discord `#5865f2/#3442d9/#23272a/#2c2f33/#57f287/#de2761`.
- Type roles: Theinhardt 15/18/23/35px with 0.36-0.46px tracking; OZIK Black up to 358px at `-0.01em`; ABC Ginto Nord Discord all-caps 36-61px.
...
- FORA block editorial type: `#ffffff/#000000/#a9553c/#a04d35/#ddbdea/#ffffff59`; Theinhardt 15/18/23/35px with 0.36-0.46px tracking; 6px base, 25px card padding; content blocks 0px, secondary modules 5px, tags 9999px. Treat terracotta and lilac as type-block roles, not ambient decoration.
- Datalands oversized dark type: `#000000/#ffffff/#111212/#f3f3ef/#3d3d3d/#d9d9d9/#1d1a1a`, CTA `#fc74dd`, accents `#122d8b/#94bcee/#ff4c33`; OZIK Black hero up to 358px with `-0.01em`, Martian Mono 18px inputs; controls 96px radius with 48px vertical and 36px horizontal padding; never use small sharp buttons.
- Discord expressive stage type: `#5865f2/#3442d9/#23272a/#2c2f33/#99aab5/#babcd9/#57f287/#de2761`; ABC Ginto Nord Discord 700/800 all-caps 36-61px `-0.01em`, ABC Ginto body 16/20px; 80-120px sections, 32-48px panels, 12/16px buttons, 104px pills; type motion can overlap characters/products, but labels stay readable.
...
- FORA: Theinhardt 15/18/23/35px, flat blocks, readable text-first experiments.
- Datalands: OZIK Black hero up to 358px, Basis Grotesque Pro body, Martian Mono 18px inputs.
- Discord: all-caps ABC Ginto Nord 36-61px with `-0.01em`; never use it for long body copy.
...
- FORA uses 6px base, 25px card padding, 0px primary blocks, 5px secondary modules, 9999px tags.
- Datalands uses 80px sections, 48px cards, 96px control radius, and huge type as the composition.
- Discord uses 80-120px sections, 32-48px panels, 12/16px buttons, 104px pills.
...
- FORA block tags: terracotta/lilac modules with 0px/5px geometry.
- Datalands oversized controls: 96px radius with 48px vertical and 36px horizontal padding; no small sharp buttons.
- Discord stage cards: character/product overlap panels with blurple CTA and readable labels.
...
Refero motion delta:
- Discord type/stage motion can overlap characters/products; FORA stays hard-cut/block-based; Datalands relies on massive type scale, not constant movement.
...
- If the page looks like generic playful or cyber-neon, reduce color count to one source family and restore the source type scale/radius.
...
- Refero anti-dilution: do not combine FORA terracotta/lilac, Datalands pink/blue/red, and Discord blurple as one rainbow palette.
- Do not make every component rounded; FORA needs 0px blocks, Datalands needs 96px controls, Discord needs 104px pills.
