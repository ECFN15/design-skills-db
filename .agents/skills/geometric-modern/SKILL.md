...
Refero ready-to-use deltas from Ventriloc/Calendly/(dot)connect:
- Token roles: Ventriloc `#202020/#ffffff/#efefef/#f5f5f5/#ebe6dd/#ff682c/#816729`; Calendly `#0b3558/#006bff/#476788/#d4e0ed/#f8f9fb/#ffffff`; (dot)connect `#fcfbf8/#ededea/#001011/#0f1e1f/#c1c4c2/#fd5321/#007aff`.
- Type roles: PolySans display `66px/.91/-0.0200em`; Gilroy 50/68/80px; AeonikPro 16-101px plus DotConnect 19/24/36/73px.
...
- Ventriloc modular operations geometry: `#202020/#ffffff/#efefef/#f5f5f5/#ebe6dd/#4d4d4d/#828282`, accent `#ff682c`; PolySans display `66px/.91/-0.0200em`, Inter UI 12-18px; 4px base, 80px sections, 40px cards, 20px gaps; 8px cards, 20px controls, 200px avatars.
- Calendly conversion geometry: `#0b3558/#006bff/#476788/#d4e0ed/#f8f9fb/#ffffff/#e55cff/#8247f5`; Gilroy 400-700 with 50/68/80px display; 8px base, 40px sections, 8px gaps; radii ladder 4/8/12/16/24px and 50px badges; blue focus and CTA define the grid.
- (dot)connect blueprint geometry: `#fcfbf8/#ededea/#001011/#0f1e1f/#c1c4c2/#fd5321/#007aff`; AeonikPro 16-101px, DotConnect 19/24/36/73px; 8px base, 48px sections, 24px cards/gaps; badges 8px, cards 20px, buttons 24px, decorative blocks 48px.
...
- Ventriloc: PolySans display plus Inter 12-18px UI.
- Calendly: Gilroy 400-700 for conversion geometry.
- (dot)connect: AeonikPro + DotConnect display; use DotConnect only for brand/coordinate marks, not body copy.
...
- Ventriloc: 4px base, 80px sections, 40px cards, 20px gaps, 8px cards, 20px controls.
- Calendly: 8px base, 40px sections, 8px gaps, radius ladder 4/8/12/16/24/50px.
- (dot)connect: 8px base, 48px sections, 24px cards/gaps, 8px badges, 20px cards, 24px buttons, 48px decorative modules.
...
- Ventriloc: 20px buttons/inputs, 200px avatars, 2px nav underline hover.
- Calendly: blue CTA, 16px elevated conversion cards, 50px badges.
- (dot)connect: filled ink button, outlined blue secondary, orange action modules.
...
Refero state deltas:
- Ventriloc hover is 2px bottom border; Calendly focus/active uses `#006bff`; (dot)connect action/focus maps to `#fd5321/#007aff`.
...
Refero motion delta:
- No source-specific durations were observed for Ventriloc/Calendly/(dot)connect. Use existing geometric timing; animate grid reveals and focus states only, never arbitrary shape drift.
...
- Refero anti-dilution: do not average the radius systems; choose Ventriloc 8/20/200, Calendly 4-50, or (dot)connect 8/20/24/48.
- Do not use source accents as decorative blobs; each color must sit on a module, CTA, badge, or grid state.
