...
**URL:** https://graza.co
**Refero ID:** f2a84e0f-cf77-41fa-ade0-b062a3a42495
**Theme:** light
...
- **Classic serif for headlines** (artisanal/retro)
...
## Spacing & Shapes
- Density: spacious
- Page max-width: **1440px** (rare in motion sites, Pastel uses constraint)
- Scale: 4, 8, 10, 12, 16, 20, 24, 30, 32, 35, 36, 40, 48, 60, 68, 100
- Section padding: 24px and 35px multiples

### Border Radius (multi-tier soft)
| Element | Value |
|---------|-------|
| inputs | 8px |
| buttons | 10px |
| default | 10px |
| **images** | **20px** (signature soft photo cards) |
| badges | 9999px |

## Components

### Primary CTA
**Zest Yellow bg, Grove Green text**, 10px radius, 20px horizontal / 24-35px vertical padding. GT Alpina Typewriter 16px.

### Ghost Button (Primary)
Transparent bg, Grove Green text + border, GT Alpina Typewriter.

### Ghost Button (Contrast)
Transparent, Buttermilk text + border (for dark backgrounds).

### Pill Badge
Transparent bg, Grove Green text, **9999px radius**, 32px horizontal padding. Apercu 13px.

### Segmented Button (Left)
Transparent, Grove Green text + border, **`10px 0 0 10px` radius** (left-only rounding).

### Segmented Button (Right)
**`0 10px 10px 0` radius** (right-only rounding).

### Text Input
Transparent bg, Grove Green text + border, 8px radius, 16px all-side padding.
...
- Grove Green text on Buttermilk/Farmhouse Gray bg (AAA contrast)
- 20px radius on large images (signature)
- **Zest Yellow ONLY for primary CTA bg** (with Grove Green text)
- 8-10px radius minimum on interactive
- GT Alpina Typewriter for body 16px weight 400
- Alternating bg colors in major sections

## Don'ts
- No pure black or stark white (Grove Green + Buttermilk)
- No generic sans-serif for headings (Garamond Condensed critical)
- No sharp 0px corners on interactive (8px minimum)
- No Zest Yellow for small text or secondary
- No excessive shadows or gradients
- No breaking visual rhythm of alternating bg colors
- No dense info packing (spacious required)
