...
Refero ready-to-use deltas from Studio Gruhl/Discord/SquadEasy:
- Token roles: Studio Gruhl dark `#18181b/#2e2e30/#ffffff/#969696/#000000`; Discord stage `#5865f2/#3442d9/#23272a/#2c2f33/#99aab5/#babcd9/#57f287/#de2761`; SquadEasy color blocks `#e1c19e/#adabff/#e4ff60/#7fb6e6/#ea5da3/#6fb853/#000000/#f6f6f6`.
- Type roles: GreedStandard 80px/1; ABC Ginto Nord Discord all-caps 36-61px with `-0.01em`; SquadEasy display 110px/.87, 80px/1, up to 220px.
...
Refero motion deltas:
- Studio Gruhl observed transition: `0.5s ease` for opacity/translate on compact dark UI.
- Discord stage motion: parallax/overlap can happen at section level; CTA hover color moves `#5865f2 -> #3442d9`.
- SquadEasy section motion: use color-block transitions, angled cutouts, and progress path steps instead of generic fade-in rows.
...
- Studio Gruhl editorial motion: `#18181b/#2e2e30/#ffffff/#969696/#000000`; GreedStandard 400/700 display `80px/1`, body 16px/1.2, Arial captions; 120px section rhythm, 16px cards, 10px gaps, cards 9px, buttons 12px; transitions are `0.5s ease` opacity/translate, never layout resizing.
- Discord stage motion: `#5865f2/#3442d9/#23272a/#2c2f33/#99aab5/#babcd9/#57f287/#de2761`; ABC Ginto Nord Discord 700/800 all-caps 36-61px with `-0.01em`, ABC Ginto body 16/20px; 1200px max, 80-120px sections, 32-48px cards, buttons 12/16px, panels 24px, pills 104px; animate character/product overlap on a pinned stage while CTA hover moves `#5865f2 -> #3442d9`.
- SquadEasy color-block motion: `#e1c19e/#adabff/#e4ff60/#7fb6e6/#ea5da3/#6fb853/#000000/#f6f6f6`; display up to 220px with `110px/.87` and `80px/1`; 100px section gaps; move by color-block transitions, angled cutouts, and progress path steps rather than generic fades.
...
- Studio Gruhl: 9px cards, 12px buttons, 16px card padding, compact dark cards.
- Discord: 12/16px buttons, 24px panels, 104px pills, 32-48px cards.
- SquadEasy: lime CTA `#e4ff60`, full-bleed color bands, angled cutout media, progress path blocks.
...
- Studio Gruhl uses 120px section rhythm and 10px gaps; Discord uses 1200px max with 80-120px sections; SquadEasy uses 100px section gaps and full color-block sections.
- Keep motion source-specific: dark compact reveal, stage overlap, or color route. Do not combine all three in one viewport.
...
- Refero anti-dilution: do not use Discord blurple, SquadEasy lime, and Studio Gruhl achrome as competing CTAs.
- Do not animate layout dimensions; use transform/opacity/color/background-position and honor `prefers-reduced-motion`.
