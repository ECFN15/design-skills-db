...
- Resend dark serif-code contrast: `#000000/#292d30/#f0f0f0/#ffffff`, blue `#3b9eff`, statuses `#3ad389/#ff9592/#ffca16/#70b8ff/#baa7ff`; Domaine carries editorial headings beside Inter/ABCFavorit/CommitMono UI; 1200px max, cards 16/24px, buttons/badges 6px, tags 10px. Use serif for authority, mono for evidence.
- ElevenLabs light serif instrument: `#fdfcfc/#f5f3f1/#e5e5e5/#777169/#000000`, small accents `#0447ff/#ff4704`; Waldenburg 300 32/36/48px, 1.08-1.17 leading, `-0.64px` to `-0.96px`; 80-120px sections, 16-24px cards, 9999px pills, 20px panels, 4px inputs.
- Sequel luxury serif contrast: `#000000/#ffffff/#f5f5f0/#202020/#333333/#999999/#b3b3b3/#c0c0c0/#cccccc`; VisueltPro 300/400/500 10-128px with `-0.05em` to `0.08em`, Bradford 500 at 32/58/128px with `-0.05em/-0.025em`; 47-76px sections, 3-28px gaps, 10px cards, 9999px buttons/badges.
- State transfer: Resend status chips keep `#3ad389/#ff9592/#ffca16/#70b8ff`; ElevenLabs selected proof rows use `#f5f3f1`; Sequel disabled/meta text steps through `#999999/#b3b3b3/#c0c0c0` without introducing color.
...
Refero ready-to-use deltas from Resend/ElevenLabs/Sequel:
- Token roles: Resend dark serif-code `#000000/#292d30/#f0f0f0/#ffffff/#3b9eff` with statuses `#3ad389/#ff9592/#ffca16/#70b8ff`; ElevenLabs `#fdfcfc/#f5f3f1/#e5e5e5/#777169/#000000`; Sequel luxury contrast `#000000/#ffffff/#f5f5f0/#202020/#333333/#999999/#b3b3b3/#c0c0c0/#cccccc`.
- Type roles: Domaine for authority beside mono evidence; Waldenburg 300 at 32/36/48px; Bradford 500 at 32/58/128px with `-0.05em/-0.025em`.
...
- Resend: Domaine 77/96px, 400, `1` leading, `-0.01em`; CommitMono 12-16px for evidence.
- ElevenLabs: Waldenburg 300, 32/36/48px, 1.08-1.17 leading, `-0.64px` to `-0.96px`.
- Sequel: VisueltPro 10-128px and Bradford 32/58/128px; keep extreme display sparse.
...
- Resend: 16/24px cards, 6px buttons/badges, 10px tags, dark code proof panels.
- ElevenLabs: 9999px pill CTAs, 20px panels, 4px inputs.
- Sequel: 10px cards, 9999px buttons/badges, grayscale meta ladders.
...
Refero state deltas:
- Resend status chips use `#3ad389/#ff9592/#ffca16/#70b8ff`.
- ElevenLabs selected rows use `#f5f3f1`; Sequel disabled/meta text steps through `#999999/#b3b3b3/#c0c0c0`.
...
Refero motion delta:
- No source-specific duration was observed for Resend/ElevenLabs/Sequel. Use existing serif-display timing; animate opacity/underline/card reveal only, not serif letter spacing.
...
- Refero anti-dilution: do not mix Resend blue/status colors, ElevenLabs dots, and Sequel grayscale as equal accents.
- Do not make every serif interface a luxury card; source geometry determines 6px, 10px, 20px, or 9999px.
